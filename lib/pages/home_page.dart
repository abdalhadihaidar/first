import 'dart:ui';
import 'package:flutter_event_app/pages/ParallaxPageView.dart';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ParallaxPageView(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              Text("Nearby features", style: headerStyle),
              Spacer(),
